 ...
 */
function getLocalTextureUrl(itemId: string, nbtData?: any): string | undefined {
...
export function MinecraftItemIcon({
  ...
  const [imageUrl, setImageUrl] = useState<string | undefined>(() => getLocalTextureUrl(itemId, nbtData));
