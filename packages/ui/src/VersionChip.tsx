    ...
    <>
      ...
      >
        <div className="space-y-6">
          <div>
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">バージョン</p>
            <p className="text-lg font-semibold text-gray-900 dark:text-white">{versionInfo.version}</p>
          </div>

          <div>
            <p className="text-sm text-gray-600 dark:text-gray-400 mb-2">作者</p>
          ...
          {versionInfo.changelog && versionInfo.changelog.length > 0 && (
            <div>
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-3">更新履歴</p>
